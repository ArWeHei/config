...
| command                                                               | Description                                           |
| --------------------------------------------------------------------- | ----------------------------------------------------- |
| `git fetch —-all                                                     `| fetch the current state from origin for all repos     |
| `git reset --hard origin/<branch_name> [file]                        `| reset the current state for branch with the remote state |
| `git log —graph                                                      `| show the network graph |
| `git branch                                                          `| list all branches |
| `git branch -d/-D [branch]                                           `| delete branch |
| `git stash                                                           `| stash current changes to temprorary commit and work on something else. effectively abort current commit |
| `git tag                                                             `| tag the current state |
| `git rebase                                                          `| rebase the changes of the current branch with onto another branch |
| `git remote set-url origin https://github.com/USERNAME/REPOSITORY.git`| change the remote url for the whole repo |
...
<!-- prettier-ignore -->
<table><tr><td align="center"><a href="https://github.com/ArWeHei"><img src="https://avatars2.githubusercontent.com/u/46443020?v=4" width="100px;" alt="ArWeHei"/><br /><sub><b>ArWeHei</b></sub></a><br /><a href="https://github.com/ArWeHei/config/commits?author=ArWeHei" title="Documentation">📖</a></td></tr></table>
